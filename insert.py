...
#        					rest_id 	INT   NOT NULL);''')
	...
	conn.execute('''INSERT INTO FoodItem( name,price,quantity,description, image_url , rest_id) VALUES  ("Farmhouse Pizza", 200, 15 , "Medium Size", "images32.jpg",3);''')
	conn.execute('''INSERT INTO FoodItem( name,price,quantity,description, image_url , rest_id) VALUES ("Chicken pizza", 300, 15 , "large size", "images33.jpg",3);''')			
